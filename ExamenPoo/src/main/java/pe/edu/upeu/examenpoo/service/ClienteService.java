 ...
 */
package pe.edu.upeu.examenpoo.service;
...
public class ClienteService {
    ...
    List<Producto> listaCli = new ArrayList<>();

    public boolean saveEntidad(Producto categoria) {
    ...
    public Producto buscarCliente(String dnirucx) {
    ...
    public Producto updateEntidad(Producto clientex) {
        listaCli.stream()
                .filter(cliente
